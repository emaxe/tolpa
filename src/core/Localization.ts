...
export const translations = {
  ru: {
    ...
    formationWideBadge: '🧲 Охват +60% · Сложение +50%',
    ...
    coinChainMilestoneApex: 'ЗОЛОТАЯ ЛИХОРАДКА! 🪙',
  ...
  en: {
    ...
    formationWideBadge: '🧲 Coverage +60% · Merge +50%',
    ...
    coinChainMilestoneApex: 'GOLD RUSH! 🪙',
