  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-zinc-950/80 backdrop-blur-md select-none animate-fade-in">
      <div className="w-full max-w-2xl bg-zinc-900 border border-zinc-700 rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        {/* Content */}
        <div className="p-5 overflow-y-auto space-y-6 text-sm text-zinc-300 leading-relaxed">
          {/* Architecture Summary */}
          <section className="bg-zinc-950/70 p-4 rounded-xl border border-teal-500/30">
            ...
            <ul className="list-disc list-inside mt-2 text-xs text-zinc-400 space-y-1 font-mono">
          ...
          <section className="space-y-3">
            ...
            <div className="space-y-2 text-xs">
              <div className="bg-zinc-950/50 p-3 rounded-xl border border-amber-500/30 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-zinc-400 mt-0.5">{i18n.t('tankDesc')}</p>
                </div>
              </div>

              <div className="bg-zinc-950/50 p-3 rounded-xl border border-rose-500/30 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-zinc-400 mt-0.5">{i18n.t('ninjaDesc')}</p>
                </div>
              </div>

              <div className="bg-zinc-950/50 p-3 rounded-xl border border-emerald-500/30 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-zinc-400 mt-0.5">{i18n.t('mageDesc')}</p>
                </div>
              </div>
            </div>
          </section>
